      ...
      /*  holder.addToCart.setOnClickListener(new View.OnClickListener() {
        ...
        holder.addToCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //if already exists remove it from db
                //or add it
                if (firebaseAuth.getCurrentUser() != null) {
                    firebaseFirestore.collection("AddToCart").document(Objects.requireNonNull(firebaseAuth.getCurrentUser()).getUid())
                            .collection("CurrentUser").whereEqualTo("productName", list.get(position)
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    ...
                                    } else Toast.makeText(context, "Товар уже в корзине", Toast.LENGTH_SHORT).show();
                                }
                            });
                } else Toast.makeText(context, "Для добавления в корзину войдите в аккаунт", Toast.LENGTH_SHORT).show();
            }
        });
